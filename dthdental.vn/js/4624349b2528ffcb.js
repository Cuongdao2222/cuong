...
return 0;}
function useClerkjQuery(){if(typeof jQuery!='undefined'){return versionCompare(jQuery.fn.jquery,'1.4.3')!==1;}
return true}
function clerk_fire_power_popup(){Clerk.ui.popup('#clerk-power-popup').show();}
function clerk_close_power_popup(){Clerk.ui.popup('#clerk-power-popup').close();}
