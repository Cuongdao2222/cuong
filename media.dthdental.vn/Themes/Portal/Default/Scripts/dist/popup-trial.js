...
function createModal(type, storeName, source, preferredService, location) {
    ...
    switch (type) {
        case 1:
            ...
            break;
        case 2:
            $title = "<h2>Dùng thử Sapo Web miễn phí 7 ngày</h2><p>+100,000 doanh nghiệp & chủ shop tin dùng</p>";
            break;
        case 3:
            $title = "<h2>Dùng thử phần mềm quản lý fanpage Sapo Social</h2><p>Được tích hợp miễn phí trên Sapo</p>";
            break;
        case 4:
            $title = "<h2>Dùng thử Sapo POS miễn phí 7 ngày</h2><p>+100,000 doanh nghiệp & chủ shop tin dùng</p>";
            break;
        case 5:
